        ...
        <div className="p-6 bg-gray-100 flex-1">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-purple-500 text-white p-6 rounded-lg shadow">
              <div className="text-2xl font-semibold">{data.candidatesToReview}</div>
              <div className="mt-2">New candidates to review</div>
            </div>
            <div className="bg-green-500 text-white p-6 rounded-lg shadow">
              <div className="text-2xl font-semibold">{data.scheduleForToday}</div>
              <div className="mt-2">Schedule for today</div>
            </div>
            <div className="bg-blue-500 text-white p-6 rounded-lg shadow">
              <div className="text-2xl font-semibold">{data.messagesReceived}</div>
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <div className="flex justify-between mt-4">
                <div className="flex items-center">
                  <div className="bg-yellow-500 h-4 w-4 rounded-full mr-2">{data.AllJobs}</div>
                  <div>All Jobs</div>
                </div>
                <div className="flex items-center">
                  <div className="bg-blue-500 h-4 w-4 rounded-full mr-2">{data.Applied}</div>
                  <div>Job Applied</div>
                </div>
              </div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow">
              <div className="text-xl font-semibold mb-4">Applicants Summary</div>
              <div className="chart-container">
                <Chart
                  type='donut'
              ...
              <div className="grid grid-cols-3 gap-4 mt-4">
                ...
                <div>
                  <div className="text-2xl font-semibold">{data.applicants}</div>
