        ...
        <div className="p-6 flex-grow overflow-auto pt-20">
          <div className="bg-white shadow rounded-lg p-4">
            <div className="mb-4">
              ...
              {/* <p>Here is your time to hire report from {moment(startDate).format("MMM DD")} - {moment(endDate).format("MMM DD")}.</p> */}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white rounded-lg shadow-md p-4">
                <h4 className="text-lg font-semibold mb-4">Average Time Spent in Each Stage of the Hiring Pipeline</h4>
                <Chart options={pieChartOptions} series={pieChartSeries} type="donut" height={350} />
              </div>
              <div className="bg-white rounded-lg shadow-md p-4">
                <h4 className="text-lg font-semibold mb-4">Average Time to Hire by Recruiter (Jan - Jun 2023)</h4>
