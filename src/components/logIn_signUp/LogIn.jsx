    ...
    return (
        <div className="flex min-h-screen">
            <div className="flex flex-col justify-center w-1/2 bg-gray-100 p-10">
                <Link to={'/'}><img src={logo} alt="ColoredCow Logo" className="h-10 w-32 mb-8 hover:text-black transform transition-transform duration-300 hover:scale-110" /></Link>
            ...
            <div className="flex flex-col justify-center w-1/2 p-10 bg-white">
                <h1 className="text-3xl font-semibold mb-4 text-center">Welcome Back, Dude</h1>
                ...
                <div className="flex items-center justify-center mb-4">
                    ...
                    <span className="px-4 text-gray-600 text-center">Or login with email</span>
                    <hr className="w-full border-gray-300" />
                </div>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4 relative">
                        ...
                        <input
                            className="w-full px-4 py-2 border rounded-lg pr-12" // Added padding for the button
                            type={showPassword ? "text" : "password"}
                            id="password"
                            placeholder={showPassword ? "Password" : "Enter password"} // Toggle placeholder text
                            value={password}
                ...
                <div className="mt-4 text-center">
                    Don't have an account? <Link to="/signUp" className="text-indigo-600 hover:text-black">Sign Up</Link>
                </div>
            </div>
        </div>
    );
