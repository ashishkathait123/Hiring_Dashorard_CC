    ...
    <footer className="bg-gray-900 text-gray-200 py-12">
      <div className="container mx-auto px-4 flex flex-col lg:flex-row justify-between">
        <div className="mb-8 lg:mb-0 lg:w-1/4">
          <img src={logo} alt="ColoredCow Logo" className="h-12 w-auto mr-2 mb-4 lg:mb-0" />
        ...
        <div className="lg:w-1/4">
          ...
          <div className="flex flex-col sm:flex-row">
            ...
            />
            <button className="bg-indigo-600 text-white py-2 px-4 rounded-b sm:rounded-r sm:rounded-b-none">Subscribe</button>
          </div>
        </div>
      </div>
      <div className="border-t border-gray-700 mt-8 pt-6">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 mb-4 md:mb-0">&copy; 2024 @ ColoredCow. All rights reserved.</p>
